...
export const Portfolio = () => {
  ...
  const getAnimationClass = (index) => {
    return index === activeSection ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10';
  };

  return (
    <div className="font-sans overflow-x-hidden">
      <div className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrollY > 100 ? 'bg-white shadow-lg' : 'bg-transparent'}`}>
        <Header />
      </div>
      ...
      <section className="relative h-screen overflow-hidden">
        <div className="absolute inset-0">
          <div 
            ...
            style={{ 
              backgroundImage: "url('https://images.unsplash.com/photo-1531297484001-80022131f5a1?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8dGVjaHxlbnwwfHwwfHx8MA%3D%3D')",
            ...
            {[
              {
                ...
                image: "https://img.freepik.com/free-photo/representations-user-experience-interface-design_23-2150104516.jpg?semt=ais_hybrid&w=740"
              },
              {
                icon: "💻",
              ...
              },
              {
                ...
                image: "https://t3.ftcdn.net/jpg/05/00/79/02/360_F_500790266_gaZS8kRQeZsUbD1zKOJJ8bjI0uwNLghi.jpg"
              }
            ].map((service, index) => (
              <div 
                key={index}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "Travel App", category: "Mobile", image: "https://d32myzxfxyl12w.cloudfront.net/assets/images/article_images/823b1ed0f9fd80db3592760d92eb9036df3433e1.webp?1702569414" },
              { title: "Brand Identity", category: "Branding", image: "https://bcassetcdn.com/public/blog/wp-content/uploads/2020/10/19163806/Header-Developing-a-Brand-Identity-for-Beginners-B.png" },
              { title: "News Platform", category: "Web Development", image: "https://www.apptunix.com/blog/wp-content/uploads/sites/3/2021/07/cost.jpg" },
              { title: "Social Network", category: "Full Stack", image: "https://visiblenetworklabs.com/wp-content/uploads/2023/01/Foundations-SNA.png" }
            ].map((project, index) => (
              <div 
                key={index} 
                className={`group relative overflow-hidden rounded-lg shadow-lg transition-all duration-700 delay-${index * 100} ${getAnimationClass(1)}`}
              >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { name: "Marcus Lee", role: "UX Designer", image: "https://img.freepik.com/premium-photo/portrait-asian-businessman-wearing-suit-blue-background_960396-63478.jpg" },
              { name: "Jessica Patel", role: "Project Manager", image: "https://img.freepik.com/premium-photo/business-woman-blue-suit-white-background_564692-62769.jpg" }
            ].map((member, index) => (
              <div 
                key={index}
                className={`bg-white/10 backdrop-blur-md rounded-xl overflow-hidden transform transition-all duration-700 delay-${index * 150} hover:translate-y-[-10px] ${getAnimationClass(2)}`}
              >

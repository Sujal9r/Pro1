  ...
  const features = [
    {
      ...
      description: "Bank-grade security protocols that protect every financial transaction",
      icon: "🔒"
    },
    {
      title: "Financial Analytics",
      description: "Real-time insights and reporting to track performance and growth",
      icon: "📊"
    },
    {
      title: "Multiple Payment Methods",
      description: "Support for all major payment gateways and financial instruments",
      icon: "💳"
    },
    {
      title: "Automated Reconciliation",
      description: "Smart systems that automatically balance accounts and identify discrepancies",
      icon: "🔄"
    }
  ];
  ...
  const financialSolutions = [
    {
      ...
      price: 1299,
      features: ["Secure Payment Gateway", "Basic Financial Reports", "User Authentication", "3 Months Support"],
      popular: false
    },
    {
      id: 2,
      ...
      price: 2999,
      features: ["Advanced Security Protocols", "Comprehensive Analytics", "Multi-currency Support", "Automated Reconciliation", "1 Year Priority Support"],
      popular: true
    },
    {
      id: 3,
      ...
      price: 5999,
      features: ["Custom Financial Workflows", "API Integration", "Advanced Fraud Detection", "Multi-branch Support", "Dedicated Account Manager"],
      popular: false
    }
  ];
      ...
      <section className={`pt-20 pb-32 px-4 md:px-12 transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
        <div className="max-w-6xl mx-auto mt-[100px]">
          ...
          <p className="text-xl md:text-2xl mb-12 text-sky-100 max-w-3xl">
            S9r Technology builds secure, scalable financial platforms that power modern businesses and institutions.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {financialStats.map((stat, index) => (
              ...
              >
                <div className="text-3xl md:text-4xl font-bold text-sky-300 mb-2">{stat.value}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {financialSolutions.map((solution) => (
              ...
              >
                ...
                <div className="p-8">
                  <h3 className="text-2xl font-bold mb-4 text-sky-200">{solution.name}</h3>
      ...
      <section className="py-20 px-4 bg-indigo-900 bg-opacity-40">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Advanced identity verification to prevent unauthorized access"
                  },
                  {
                    title: "Fraud Detection Systems",
                    description: "AI-powered monitoring to detect and prevent suspicious activities"
                  },
                  {
                    title: "Regulatory Compliance",
                    description: "Solutions built to meet GDPR, PCI DSS, SOC 2, and other global standards"
                  }
                ].map((item, index) => (
                  <div key={index} className="bg-purple-900 bg-opacity-50 p-4 rounded-lg">
                    <h3 className="text-xl font-bold mb-2 text-sky-300">{item.title}</h3>
            ...
            <div className={`bg-indigo-800 rounded-2xl p-6 shadow-2xl relative ${
              scrollPosition > 800
                ? 'opacity-100 translate-x-0'
                : 'opacity-0 translate-x-10'
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-4 text-sky-200">Security Certifications</h3>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  {['ISO 27001', 'PCI DSS', 'GDPR', 'SOC 2'].map((cert, idx) => (
                    <div key={idx} className="bg-indigo-700 bg-opacity-50 p-3 rounded-lg text-center">
                      <p className="font-bold text-white">{cert}</p>
                    </div>
                  ))}
                </div>
                <p className="text-purple-100 mb-6">
                  Our financial solutions adhere to the highest industry security standards to protect your business and customer data.
                </p>
      ...
      <section className="py-16 px-4 bg-indigo-900 bg-opacity-30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {["Stripe", "PayPal", "Visa", "Mastercard", "American Express", "Plaid", "Square", "Wise"].map((partner, index) => (
              <div 
                key={index} 
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-purple-800 via-indigo-800 to-sky-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-12 text-sky-100">
            Let's build a secure, scalable financial platform tailored to your business needs.
          </p>

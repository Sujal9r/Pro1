  ...
  const testimonials = [
    {
      ...
      content: "S9r Technology transformed our patient care experience. Their platform is intuitive, secure, and our staff adopted it immediately.",
    ...
    },
    {
      ...
      content: "The customization options and HIPAA compliance made our transition to digital healthcare seamless. Highly recommended!",
      avatar: "/api/placeholder/40/40"
    },
    {
      id: 3,
      ...
      content: "S9r's attention to detail and understanding of healthcare workflows sets them apart from other providers we've worked with.",
      avatar: "/api/placeholder/40/40"
    }
  ];
  ...
  const features = [
    {
      ...
      description: "Our platforms are built with security at the core, ensuring all patient data is protected according to strict healthcare standards."
    },
    {
      title: "Seamless Integration",
      description: "Connect with existing healthcare systems, lab equipment, and third-party services with minimal disruption."
    },
    {
      title: "Patient Engagement",
      description: "Improve patient outcomes with user-friendly portals, automated reminders, and personalized health information."
    },
    {
      title: "Mobile-First Design",
      description: "Access critical patient information anywhere with fully responsive design optimized for all devices."
    },
    {
      title: "Advanced Analytics",
      description: "Make data-driven decisions with powerful reporting tools and predictive analytics."
    },
    {
      title: "24/7 Support",
      description: "Our dedicated healthcare support team is always available to help you resolve any issues."
    }
  ];
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="mb-6 transform translate-y-0 opacity-100 transition-all duration-1000">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8">
              Custom healthcare platforms that enhance patient care and streamline operations
            </p>
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16 bg-indigo-900 bg-opacity-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            <button 
              className={`px-6 py-2 rounded-full transition-all duration-300 ${activeTab === "emr" ? "bg-purple-600 text-white" : "bg-purple-900 bg-opacity-50 text-gray-300"}`}
              onClick={() => setActiveTab("emr")}
            >
              EMR Systems
            </button>
            <button 
              className={`px-6 py-2 rounded-full transition-all duration-300 ${activeTab === "telehealth" ? "bg-purple-600 text-white" : "bg-purple-900 bg-opacity-50 text-gray-300"}`}
            ...
            <div className="order-2 md:order-1">
              {activeTab === "emr" && (
                <div className="animate-fadeIn">
                  <h3 className="text-2xl font-bold mb-4 text-purple-200">Electronic Medical Records</h3>
                  <p className="text-gray-200 mb-6">
                    Streamline your practice with intuitive, secure electronic medical record systems designed specifically for healthcare providers.
                  </p>
              ...
              {activeTab === "telehealth" && (
                <div className="animate-fadeIn">
                  <h3 className="text-2xl font-bold mb-4 text-indigo-200">Telehealth Solutions</h3>
                  <p className="text-gray-200 mb-6">
                    Connect with patients remotely through secure, high-quality video consultations and remote monitoring tools.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
              ...
              {activeTab === "apps" && (
                <div className="animate-fadeIn">
                  <h3 className="text-2xl font-bold mb-4 text-sky-200">Healthcare Mobile Applications</h3>
                  <p className="text-gray-200 mb-6">
                    Engage patients and improve outcomes with intuitive, feature-rich mobile applications designed for modern healthcare needs.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16 bg-gradient-to-b from-indigo-900 to-purple-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join hundreds of healthcare providers that trust S9r Technology for their digital healthcare solutions.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">

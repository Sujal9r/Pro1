...
export default function EnhancedSideBar() {
  ...
  // Check if screen is laptop size or larger (min-width: 1024px)
  useEffect(() => {
  ...
  // Border animation effect - continuous rotation with varying speed
  useEffect(() => {
    const animateBorder = () => {
      // Sine wave pattern for varying rotation speed
  ...
  return (
    <div className="sidebar-container fixed left-0 top-0 h-full z-50 pointer-events-none">
      <div className="pointer-events-auto">
        ...
        >
          <div className="relative h-auto overflow-hidden rounded-r-xl">
            <div 
              ...
              <div className="w-full flex flex-col items-center space-y-7">
                {socialIcons.map((item, index) => (
                  <div 
                    ...
                    style={{
                      transform: isVisible ? 
                        `translateX(${isAnimating ? (index % 2 === 0 ? '-8px' : '8px') : '0'})` : 
                        'translateX(-24px)',
                    ...
                    <div 
                      ...
                      style={{
                        background: activeIconIndex === index 
                          ? `linear-gradient(135deg, ${item.color}90, ${item.color}40)`
                          : 'rgba(15, 15, 35, 0.7)',
                    ...
                    >
                      ...
                      {activeIconIndex === index && (
                        <div 
                          ...
                          style={{
                            background: `radial-gradient(circle, ${item.hoverGlow} 0%, transparent 70%)`,
                            filter: 'blur(5px)'
                          }}
                        ></div>
                      )}

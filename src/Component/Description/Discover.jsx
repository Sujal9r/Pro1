    ...
    <div className="bg-slate-900 text-white overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 mb-12 md:mb-0 text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                ...
                <button className="bg-slate-800 hover:bg-slate-700 border border-slate-700 text-gray-300 hover:text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-medium flex items-center transition-all">
                  Experience Demo
      ...
      <div className={`py-16 md:py-24 transition-all duration-1000 ${isVisible[2] ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
        <div className="container mx-auto px-4 sm:px-6">
          ...
          {/* Testimonials - scrollable on small screens */}

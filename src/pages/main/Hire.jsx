          ...
          <div className="flex justify-center p-5 mb-12">
            <div className="relative w-full max-w-3xl group">
              <input
                ...
                className="w-full p-5 border-2 border-cyan-700 rounded-md shadow-xl text-lg bg-black/30 backdrop-blur-lg text-white placeholder-blue-300 focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all duration-300"
              />
              ...
              <div className="absolute -bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600"></div>
            </div>
          </div>
